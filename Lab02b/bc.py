...
time_start_interp = 20
time_end_interp = 60

def main():
	time_diff = (time_end_interp - time_start_interp) / 5
	for i in range(6):
		time_check = time_start_interp + time_diff * i
		print(calculate_new_position(time_1, pos_1, time_2, pos_2, time_check))
		print('-----------------')
	

def calculate_new_position(time_1, pos_1, time_2, pos_2, time_check):
	pos_new = (
	...
	return (f"Time of interest: {time_check} seconds\n"
	        f"x0 = {pos_new[0]} m\n"
	        f"y0 = {pos_new[1]} m\n"
	        f"z0 = {pos_new[2]} m")
